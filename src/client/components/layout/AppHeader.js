...
export default function AppHeader({ title, subtitle, showBack = false, showLogout = true }) {
    ...
    return (_jsx("header", { className: "app-header", children: _jsxs("div", { className: "app-header__content", children: [_jsxs("div", { className: "app-header__text", children: [_jsx("p", { className: "app-header__eyebrow", children: "Controle Operacional" }), _jsx("h1", { className: "app-header__title", children: title }), subtitle ? _jsx("p", { className: "app-header__subtitle", children: subtitle }) : null] }), _jsxs("div", { className: "app-header__actions", children: [showBack ? (_jsx(Button, { variant: "secondary", type: "button", className: "app-header__back", onClick: () => navigate(-1), children: "Voltar" })) : null, _jsx(Button, { variant: "secondary", type: "button", onClick: () => navigate("/perfil"), children: "Perfil" }), showLogout ? (_jsx(Button, { variant: "danger", type: "button", className: "app-header__logout", onClick: handleLogout, children: "Deslogar" })) : null] })] }) }));
}
