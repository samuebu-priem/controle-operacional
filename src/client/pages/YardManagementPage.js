    ...
    h("div", { className: `operational-yard__shell${sideCollapsed ? " operational-yard__shell--panel-collapsed" : ""}` },
      ...
      h("aside", { className: `operational-sheet${selectedFleet || selectedArea ? " operational-sheet--open" : ""}${sideCollapsed ? " operational-sheet--collapsed" : ""}` },
        ...
        selectedFleet ? h("div", { className: "operational-sheet__content" },
          ...
          h("div", { className: "operational-area-actions" }, h(Button, { onClick: () => { setSelectedFleet(null); setSelectedAllocation(null); setTargetPatioId(selectedArea.patioId); setTargetAreaId(selectedArea.id); setModal("area-add"); } }, "Adicionar frota"), h(Button, { variant: "secondary", onClick: () => openBulk(selectedArea) }, "Preencher pátio")),
