          ...
          children: [
            ...
            _jsx("div", {
              ...
              children: _jsxs("table", {
                ...
                children: [
                  _jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Frota" }), _jsx("th", { children: "Data" }), _jsx("th", { children: "Colaborador" }), _jsx("th", { children: "Resultado" }), _jsx("th", { children: "Motivo" }), _jsx("th", { children: "Anexos" }), _jsx("th", { children: "Inspetor" }), _jsx("th", { children: "Acoes" })] }) }),
                  _jsx("tbody", { children: inspecoes.map((item) => _jsxs("tr", { children: [_jsx("td", { children: item.frota }), _jsx("td", { children: formatDateTime(item.createdAt) }), _jsx("td", { children: item.colaborador?.nome ?? "Nao informado" }), _jsx("td", { children: _jsx("span", { className: `quality-pill quality-pill--${item.resultado.toLowerCase()}`, children: item.resultado }) }), _jsx("td", { children: item.motivoLabel ?? "-" }), _jsx("td", { children: item.fotos?.length ?? 0 }), _jsx("td", { children: item.inspetor }), _jsx("td", { children: _jsx(Button, { type: "button", variant: "secondary", onClick: () => setSelected(item), children: "Abrir" }) })] }, item.id)) })
                ]
              })
            }),
